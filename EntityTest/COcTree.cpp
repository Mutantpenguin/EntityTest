...
bool COcTree::Add( const ecs::CEntity &entity, const glm::vec3 &position, const CBoundingBox * const boundingBox )
{
	if( boundingBox )
	{
...
void COcTree::ForEach( const std::function< void( const ecs::CEntity &entity ) > lambda ) const
{
	if( m_containsEntities )
	{
...
void COcTree::ForEachIn( const glm::vec3 &spherePosition, const CSphere &sphere, const std::function< void( const ecs::CEntity &entity ) > lambda ) const
{
	if( m_containsEntities )
	{
...
void COcTree::ForEachIn( const glm::vec3 &boxPosition, const CBoundingBox &box, const std::function< void( const ecs::CEntity &entity ) > lambda ) const
{
	if( m_containsEntities )
	{
...
void COcTree::ForEachIn( const CFrustum &frustum, const std::function< void( const ecs::CEntity &entity ) > lambda ) const
{	
	if( m_containsEntities )
	{
...
bool COcTree::Exists( const std::function< bool( const ecs::CEntity &entity ) > lambda ) const
{
	if( m_containsEntities )
	{
		for( const auto &child : m_children )
...
bool COcTree::ExistsIn( const glm::vec3 &spherePosition, const CSphere &sphere, const std::function< bool( const ecs::CEntity &entity ) > lambda ) const
{
	if( m_containsEntities )
	{
		switch( Intersection( spherePosition, sphere, m_position, m_region ) )
...
bool COcTree::ExistsIn( const glm::vec3 &boxPosition, const CBoundingBox &box, const std::function< bool( const ecs::CEntity &entity ) > lambda ) const
{
	if( m_containsEntities )
	{
		switch( Intersection( boxPosition, box, m_position, m_region ) )
...
bool COcTree::ExistsIn( const CFrustum &frustum, const std::function< bool( const ecs::CEntity &entity ) > lambda ) const
{
	if( m_containsEntities )
	{
		switch( Intersection( frustum, m_position, m_region ) )
