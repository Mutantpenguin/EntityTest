...
public:
	...
	virtual void ForEachIn( const glm::vec3 &spherePosition, const CSphere &sphere, const std::function< void( const CEntity &entity ) > lambda ) const = 0;
	virtual void ForEachIn( const glm::vec3 &boxPosition, const CBoundingBox &box, const std::function< void( const CEntity &entity ) > lambda ) const = 0;
	virtual void ForEachIn( const CFrustum &frustum, const std::function< void( const CEntity &entity ) > lambda ) const = 0;
